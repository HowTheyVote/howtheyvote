...
class Document:
    ...
    def termlist(self) -> Iterator[TermListItem]: ...
...
class TermGenerator:
    ...
    def set_stemmer(self, stemmer: Stem) -> None: ...
    def set_stemming_strategy(self, strategy: int) -> None: ...
...
class QueryParser:
    ...
    FLAG_SYNONYM: int
    FLAG_WILDCARD: int
    FLAG_AUTO_SYNONYMS: int
    FLAG_AUTO_MULTIWORD_SYNONYMS: int
    STEM_NONE: int
    STEM_SOME: int
    STEM_ALL: int
    STEM_ALL_Z: int
    ...
    def get_corrected_query_string(self) -> bytes: ...
...
class Database:
    ...
    def spellings(self) -> Iterator[TermListItem]: ...
    def synonym_keys(self) -> Iterator[bytes]: ...
    def synonyms(self, term: str | bytes) -> Iterator[bytes]: ...
    def positionlist(self, docid: int, term: str) -> Iterator[int]: ...
...
class WritableDatabase(Database):
    ...
    def add_synonym(self, term: str | bytes, synonym: str) -> None: ...
    def clear_synonyms(self, term: str | bytes) -> None: ...
...
class Stem:
    def __init__(self, p: StemImplementation) -> None: ...
