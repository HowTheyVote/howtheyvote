...
class Document:
    ...
    def add_value(self, slot: int, value: str | bytes) -> None: ...
    def get_value(self, slot: int) -> bytes: ...
...
class Query:
    ...
    @overload
    def __init__(self, op: int, slot: int, limit: str) -> None: ...
    @overload
...
class Enquire:
    ...
    @overload
    def get_mset(self, first: int, maxitems: int, checkatleast: int) -> MSet: ...
    def add_matchspy(self, spy: MatchSpy) -> None: ...
...
class MatchSpy:
    def __init__(self) -> None: ...
    def __call__(self, doc: Document, weight: float) -> None: ...
